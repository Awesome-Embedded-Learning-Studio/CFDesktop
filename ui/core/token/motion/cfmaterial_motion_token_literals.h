...
inline constexpr const char* const ALL_MOTION_TOKENS[] = {
    // Durations
    MOTION_SHORT_ENTER_DURATION,    MOTION_SHORT_EXIT_DURATION,
    MOTION_MEDIUM_ENTER_DURATION,   MOTION_MEDIUM_EXIT_DURATION,
    MOTION_LONG_ENTER_DURATION,     MOTION_LONG_EXIT_DURATION,
    MOTION_STATE_CHANGE_DURATION,   MOTION_RIPPLE_EXPAND_DURATION,
    MOTION_RIPPLE_FADE_DURATION,
    // Easing
    MOTION_SHORT_ENTER_EASING,      MOTION_SHORT_EXIT_EASING,
    MOTION_MEDIUM_ENTER_EASING,     MOTION_MEDIUM_EXIT_EASING,
    MOTION_LONG_ENTER_EASING,       MOTION_LONG_EXIT_EASING,
    MOTION_STATE_CHANGE_EASING,     MOTION_RIPPLE_EXPAND_EASING,
    MOTION_RIPPLE_FADE_EASING
};
